...
fun CommunitiesScreen(navHostController: NavHostController){
    ...
    val communitydata= listOf(
        Community(image= R.drawable.communities_icon, name= "College", members= "256members"),
        Community(image= R.drawable.communities_icon, name= "Placement", members= "256members"),
        Community(image= R.drawable.communities_icon, name= "Photography Lovers", members= "256members"),
        Community(image= R.drawable.communities_icon, name= "Art", members= "256members"),
        Community(image= R.drawable.communities_icon, name= "Cybersecurity", members= "256members")
    )
            ...
            Column {
                Row {
                    if(searching){
                        ...
                        Text(text= "Communities", fontSize = 28.sp, color= Color.Black, fontWeight = FontWeight.Bold,
