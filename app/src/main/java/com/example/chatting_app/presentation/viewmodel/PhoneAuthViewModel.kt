...
import com.example.chatting_app.models.PhoneAuthUser
    ...
    fun sendVerificationCode(phoneNumber: String, activity: Activity){
        ...
        val option = object:PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
            ...
            override fun onVerificationFailed(exception: FirebaseException) {
                ...
                _authState.value = AuthState.error(exception.message ?:"Verfication failed")
            }
        }
    ...
    private fun signinWithCredential(credential: PhoneAuthCredential, context: Context){
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener{task->
             if(task.isSuccessful){
                 ...
                 val phoneAuthUser= PhoneAuthUser(userId = user?.uid?:"",
